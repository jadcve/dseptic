...
<div id="page-wrapper" class="gray-bg" style=";width: 100%;margin-left: 0px;">
    <div style="margin-bottom: 30px;width: 50%;position:inherit ;float: left;margin-left: -25%;margin-top: 10px;" class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            <div>
