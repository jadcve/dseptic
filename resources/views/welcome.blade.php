...
<html lang="en">
    ...
    <body class="gray-bg">
        ...
        <div style="margin-bottom: 30px;width: 50%;position:inherit ;float: left;margin-left: 20%;margin-top: 80px;" class="middle-box text-center loginscreen   animated fadeInDown">
              <h3 class="logo-name">D u l w o r t h </h3>
              <h3 class="logo-name">S e p t i c </h3>
        </div>
        <div class="container">
