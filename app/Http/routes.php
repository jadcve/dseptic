...
$router->group(['middleware' => 'auth','prefix' => 'admin'], function() {
    ...
    Route::post('/updatecustomer_info', 'AdminController@updatecustomer_info');
    Route::post('/updatecity', 'TicketController@updatecity');
    Route::get('/auth/register', 'AdminController@getRegister');
    Route::get('/user_list', 'AdminController@listRegister');
    Route::get('/user/{user}', 'AdminController@editRegister');
    Route::post('/user_update', 'AdminController@UpdateRegister');
    ...
    Route::post('/validate_email', 'AdminController@validate_email');  
